...
var S = {
  init: function () {
    ...
    if (i !== -1) {
      ...
      // S.UI.simulate('|#countdown 5||其实我一直|想对你说|I LOVE YOU|希望|你|能给我|一个|机会|呵护你|爱护你|#rectangle|');
      S.UI.simulate('|#countdown 5|你来啦°|在这个|大喜日子|☆里★|我|有句话|想对你说|许林欣|祝你|生日快乐！|天天开心！|-闯荡留-|还有|蛋糕|真好吃☆');
