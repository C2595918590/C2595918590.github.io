...
<body style="background-image:url('./static/img/01.jpg');
            background-color: rgba(140,243,255);
          width:100%;
          height: 100%;
    ...
    <section class="am-g about">
        <div class="am-container am-margin-vertical-xl">
            <header class="am-padding-vertical">
                <h2 class="about-title about-color" onclick="window.open('http://chuangdang.jnooidc.cn/','_self','');">音乐搜索器</h2>
